...
| `integration` | Public CLI envelopes and end-to-end archive, doctor, and team workflow behavior | `test_cli.py`, `test_cli_snapshots.py`, `test_archive_cli.py`, `test_doctor.py`, `test_team_workflow.py` |
