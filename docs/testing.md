...
| `packaging` | Runtime launch/discovery, installed layouts, release baseline, CI shape, and classification contract | `test_runtime.py`, `test_runtime_discovery.py`, `test_install_smoke.py`, `test_ci_contract.py`, `test_release_baseline.py`, `test_testing_contract.py` |
