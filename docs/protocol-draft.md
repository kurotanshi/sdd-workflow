# SDD Workflow Protocol

Protocol identifier: `sdd-protocol-draft-0`

Status: public pre-1.0 draft

Normative language: RFC 2119 / RFC 8174

## 1. Purpose and conformance

This document specifies the observable protocol shared by SDD artifact
producers, runtimes, Agent adapters, and conformance tools. It is written so an
independent implementation can be evaluated without reading the reference
...
This draft may add optional diagnostics and presentation fields without
...
behavior requires an explicit protocol/version decision and updated
